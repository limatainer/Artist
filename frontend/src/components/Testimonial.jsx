   ...
   mb-4 md:p-10 md:px-12"
      >
        <h1 className="text-4xl font-semibold leading-none text-center">
          Nossos artistas na mídia
        </h1>
      </div>
      <div
        className="container mx-auto grid grid-cols-1 gap-8 lg:gap-20 
  md:px-10 md:pb-10 lg:grid-cols-2"
      >
        <div className="flex flex-col items-center mx-12 lg:mx-0">
          <div className="relative text-center">
            ...
            <p className="px-6 py-1 text-lg italic">
              Performance espetacular, Bruna é um ícone da nova geração, de
              grande carísma.
            </p>
            <svg
              xmlns="http://www.w3.org/2000/svg"
        ...
        <div className="flex flex-col items-center max-w-lg mx-12 lg:mx-0">
          <div className="relative text-center">
            ...
            <p className="px-6 py-1 text-lg italic">
              As fotos com o Marco sempre ficam muito profissionais, ele tem uma
              beleza natural.
            </p>
            <svg
              xmlns="http://www.w3.org/2000/svg"
